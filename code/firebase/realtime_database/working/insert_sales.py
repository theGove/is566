...
def make_order():
    ...
    # TO DO:  add a reference to the sale node in RTDB
    # sale_ref = ...
    order_lines = []
    order_total=0
    ...
    for prod in prod_set:
        # TO DO: Get the infomation about the selected product
        # product_dict = ...
    ...
    sale_time=time.time()    
    # TO DO: build the full sale record    
    # new_sale=sale_ref.push(...)        
    
    print("Sale create with a total of: " + str(round(order_total,2)))

    # TO DO: add sale to customers
    #cust_ref = db.reference(...)
    #cust_ref. ...

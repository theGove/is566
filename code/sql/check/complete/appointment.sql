...
create table appointment(
  ...
  ,constraint valid_duration Check(DURATION >=30 and DURATION <=115)
  ,constraint valid_room_lower Check (room >=1)
  ,constraint valid_room_upper Check (room <=5)
  --,constraint valid_start Check(START_TIME < SYSDATE)
);

...
-- Show June second appointments in the format for the excel schedle vizualizer at 
-- https://filedn.com/lOHnphPm3vnROy2M4FmMMtR/linux/oracle/oracle%20Schedule%20Viewer2.xlsm

select   appt_id
       , start_time
       , duration
       , counselor
       , first_name || ' ' || last_name as clent
       , room 
from     appointment 
  join   client 
    on appointment.client_id = client.client_id 
